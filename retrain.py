...
# There are 32 different Mobilenet models to choose from, with a vwariety of file size and latency options. The first
...
def checkIfNecessaryPathsAndFilesExist():
    ...
    if len(trainingSubDirs) == 0:
        ...
        print("Did you make a separate image sub-directory for each classification type?")
        return False
    # end if
